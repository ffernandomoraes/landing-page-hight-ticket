  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[hsl(210_95%_20%)] to-[hsl(210_95%_10%)] flex items-center pt-16 md:pt-20">
      <div className="container mx-auto px-4 py-8 md:py-16">
        <div className="grid lg:grid-cols-[2fr,1fr,400px] gap-8 md:gap-12 items-center">
          
          {/* Hero Content */}
          <div className="text-white space-y-6 md:space-y-8 animate-fade-in max-w-md lg:max-w-none order-2 lg:order-1 text-center lg:text-left">
