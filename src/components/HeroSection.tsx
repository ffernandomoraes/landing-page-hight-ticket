        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-white text-white hover:bg-white hover:text-blue-900 backdrop-blur-sm transition-all duration-300"
              >
                Cases de Sucesso
              </Button>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl animate-slide-up">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Button variant="outline" className="h-12 rounded-2xl bg-gray-50 border-gray-200 hover:bg-gray-100">
