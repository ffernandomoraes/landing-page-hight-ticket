...
const AnimatedStatsCard = ({ number, unit, description, icon: Icon, lordIcon, suffix = "", colorClass = "text-blue-900" }: AnimatedStatsCardProps) => {
  ...
  return (
    <div 
      ref={ref}
      className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl p-3 md:p-6 transition-all duration-300 shadow-gradient-hover hover:bg-white/25 hover:scale-105 cursor-pointer group relative overflow-hidden w-full h-[180px] md:h-[200px] flex flex-col"
    >
