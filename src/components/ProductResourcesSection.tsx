              ...
              {resources.map((resource) => {
                return (
                  <TabsTrigger
                    key={resource.id}
                    value={resource.id}
                    className="flex flex-col items-center gap-1 md:gap-2 p-2 md:p-4 rounded-md data-[state=active]:bg-brand-blue data-[state=active]:text-white data-[state=active]:shadow-md transition-all duration-300 hover:bg-stone-50 data-[state=active]:hover:bg-brand-blue/90 group"
                  >
                    <LordIcon
                    ...
                    <Card className="bg-white border-0 shadow-lg rounded-2xl overflow-hidden">
                      <CardContent className="p-0">
                        <div className="grid lg:grid-cols-2 gap-0">
                          {/* Content Column */}
                          <div className="p-4 md:p-8 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
                            <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                              ...
                              <div>
                                <h3 className="text-lg md:text-xl font-bold text-stone-800 leading-tight">
                                  {resource.title}
                                </h3>
                              </div>
                            </div>
                            ...
                            <div className="space-y-3 mb-6 md:mb-8">
                              {resource.features.map((feature, featureIndex) => (
                                ...
                                >
                                  ...
                                  <span className="text-sm md:text-base text-stone-700 leading-relaxed">
                                    {feature}
                                  </span>
                                </div>
                              ))}
                              ...
                              {resource.comingSoon?.map((feature, featureIndex) => (
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-2 flex-wrap">
                                    <span className="text-sm md:text-base text-stone-600 leading-relaxed">
                            ...
                            {/* CTA Button */}
                            <Button size="default" className="bg-brand-blue hover:bg-brand-blue/90 text-white w-full md:w-fit">
                              Falar com a Eduzz
                          ...
                          {/* Image Column */}
                          <div className="relative bg-gradient-to-br from-stone-100 to-stone-200 flex items-center justify-center p-4 md:p-8 order-1 lg:order-2">
